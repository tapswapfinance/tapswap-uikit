...
var Icon$M = function () {
    return React.createElement("img", { width: "220px", height: "50px", src: "/images/mobile-logo.png", alt: "logo-icon" });
};
...
var Icon$F = function () {
    return React.createElement("img", { width: "24px", height: "24px", src: "/images/price-token.png", alt: "pancake-round-icon" });
};
...
var templateObject_1$G, templateObject_2$f, templateObject_3$7, templateObject_4$3;
...
var StyledLink$1 = styled.a(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
var Link = function (_a) {
    var external = _a.external, props = __rest(_a, ["external"]);
    var internalProps = external ? getExternalLinkProps() : {};
    return React.createElement(StyledLink$1, __assign({}, internalProps, props));
};
Link.defaultProps = {
    color: "primary",
};
...
var Icon$t = function () {
    return React.createElement("img", { src: "/images/pageloader.png", alt: "icon-item" });
};
...
var RotatingPancakeIcon = styled(Icon$s)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$t)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var templateObject_1$j, templateObject_2$9, templateObject_3$6, templateObject_4$2;
...
var Logo$2 = function () {
    return React.createElement("img", { width: "220px", height: "50px", src: "/images/logo.png", alt: "logo" });
};
...
var StyledAnchorLink = styled(Button)(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
    var theme = _a.theme;
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledAnchorLink, { href: href, "aria-label": "Pancake home page", onC: true }, innerLogo)) : (React.createElement(StyledLink, { to: href, component: Link$1, "aria-label": "Pancake home page" }, innerLogo))));
};
...
export { Icon$16 as AddIcon, Alert, Icon$15 as ArrowBackIcon, Icon$14 as ArrowDownIcon, Icon$13 as ArrowDropDownIcon, Icon$12 as ArrowDropUpIcon, Icon$11 as ArrowForwardIcon, Icon$10 as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$$ as BinanceIcon, Icon$18 as BlockIcon, Box, Breadcrumbs, Icon$_ as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$Y as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$Z as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1a as CheckmarkCircleIcon, Icon$X as CheckmarkIcon, Icon$W as ChevronDownIcon, Icon$V as ChevronLeftIcon, Icon$U as ChevronRightIcon, Icon$T as ChevronUpIcon, Icon$S as CloseIcon, Icon$R as CogIcon, Icon$Q as CommunityIcon, ConnectorNames, Icon$P as CopyIcon, Dropdown, Icon$19 as ErrorIcon, FallingBunnies, Flex, Heading, Icon$O as HelpIcon, IconButton, Image, Icon$17 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$N as ListViewIcon, Icon$M as LogoIcon, Icon$L as LogoRoundIcon, Menu, Icon$K as MetamaskIcon, Icon$J as MinusIcon, Modal, ModalProvider, Icon$I as NoProfileAvatarIcon, Icon$H as OpenNewIcon, Icon$F as PancakeRoundIcon, Icon$G as PancakesIcon, Icon$E as PrizeIcon, Progress, Icon$B as ProgressBunny, Radio, Icon$D as RemoveIcon, ResetCSS, Icon$x as SearchIcon, Skeleton, Spinner, Svg, Icon$w as SwapVertIcon, Icon$v as SyncAltIcon, Tag, Text, Icon$z as Ticket, Icon$y as TicketRound, ToastContainer, Toggle, Icon$C as VerifiedIcon, Icon$u as WarningIcon, Icon$A as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
