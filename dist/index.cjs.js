...
var Icon$M = function () {
    return React__default['default'].createElement("img", { width: "220px", height: "50px", src: "/images/mobile-logo.png", alt: "logo-icon" });
};
...
var Icon$F = function () {
    return React__default['default'].createElement("img", { width: "24px", height: "24px", src: "/images/price-token.png", alt: "pancake-round-icon" });
};
...
var ButtonMenuItem = function (_a) {
    ...
    return React__default['default'].createElement(Button, __assign({ as: as, variant: "primary" }, props));
};
...
var StyledLink$1 = styled__default['default'].a(templateObject_1$m || (templateObject_1$m = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
var Link = function (_a) {
    var external = _a.external, props = __rest(_a, ["external"]);
    var internalProps = external ? getExternalLinkProps() : {};
    return React__default['default'].createElement(StyledLink$1, __assign({}, internalProps, props));
};
Link.defaultProps = {
    color: "primary",
};
...
var Icon$t = function () {
    return React__default['default'].createElement("img", { src: "/images/pageloader.png", alt: "icon-item" });
};
...
var RotatingPancakeIcon = styled__default['default'](Icon$s)(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled__default['default'](Icon$t)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo$2 = function () {
    return React__default['default'].createElement("img", { width: "220px", height: "50px", src: "/images/logo.png", alt: "logo" });
};
...
var Icon$8 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 512 512", width: "20px", color: "text" }, props),
        React__default['default'].createElement("path", { d: "M15,91c-8.284,0-15,6.716-15,15v301c0,8.284,6.716,15,15,15c24.853,0,45-20.147,45-45V136C60,111.147,39.853,91,15,91z" }),
        React__default['default'].createElement("path", { d: "M392,362v30c0,8.284,6.716,15,15,15h90c8.284,0,15-6.716,15-15v-30H392z" }),
        React__default['default'].createElement("path", { d: "M392,197h-69.357c-9.911-11.003-22.405-19.427-36.643-24.489V90h41.206c3.001,1.957,13.226,15,33.794,15\n\t\t\tc24.814,0,45-20.186,45-45c0-24.814-20.186-45-45-45c-20.592,0-30.787,13.039-33.794,15h-39.36l-3.545-9.99\n\t\t\tC280.053,8.042,268.686,0,256,0c-12.686,0-24.053,8.042-28.301,20.01L224.154,30h-39.36c-3.001-1.957-13.226-15-33.794-15\n\t\t\tc-24.814,0-45,20.186-45,45c0,24.814,20.186,45,45,45c20.592,0,30.787-13.039,33.794-15H226v82.511\n\t\t\tc-14.238,5.061-26.732,13.486-36.643,24.489H90v120h99.086h0.271c16.474,18.287,40.093,30,66.643,30s50.169-11.713,66.643-30\n\t\t\th0.271H362c10.984,0,20.176,6.194,25.402,15H512v-15C512,250.725,458.275,197,392,197z" }),
        React__default['default'].createElement("path", { d: "M479.671,470.398l-14.678-25.679c-2.666-4.673-7.632-7.559-13.008-7.559h-0.015c-5.376,0-10.327,2.871-13.008,7.529\n\t\t\tl-14.678,25.781C422.776,474.163,422,478.045,422,482c0,16.538,13.462,30,30,30c16.538,0,30-13.462,30-30\n\t\t\tC482,478.241,481.537,473.664,479.671,470.398z" })));
};
...
var StyledAnchorLink = styled__default['default'](Button)(templateObject_2$5 || (templateObject_2$5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
    var theme = _a.theme;
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledAnchorLink, { href: href, "aria-label": "Pancake home page", onC: true }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, component: reactRouterDom.Link, "aria-label": "Pancake home page" }, innerLogo))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.guru/token/0x56eab07247e3e6404ac90140F20bba61375d5C3C-bsc", target: "_blank" },
